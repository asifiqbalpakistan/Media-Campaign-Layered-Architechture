...
namespace OMG_Annalect_DAL_Core.Migrations
{
    ...
    [Migration("20190504165837_Seed data document types")]
    partial class Seeddatadocumenttypes
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "d4ffc4c0-166c-4c44-ad4b-b21808c516f1",
                            ConcurrencyStamp = "3595058c-ed45-48b1-9fb6-fef21a62b732",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "8c931e76-adbf-408f-a087-c765cf792ecc",
                            ConcurrencyStamp = "2be03b55-3732-4f9f-ba9d-0894c20c3779",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "0428d927-d5d9-4cb0-9065-9d154917c56a",
                            ConcurrencyStamp = "e6fbf10f-45ad-49f4-aa76-72867b15daa7",
                            Name = "Client",
                            NormalizedName = "CLIENT"
                        },
                        new
                        {
                            Id = "46da2850-0882-480c-8629-7a08692bd9c0",
                            ConcurrencyStamp = "8313236e-c7cc-40cd-b7e5-a48bb916b98a",
                            Name = "Planner",
            ...
            modelBuilder.Entity("OMG_Annalect_DAL_Core.Models.Channel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            AddedTime = new DateTime(2019, 5, 4, 20, 58, 37, 329, DateTimeKind.Local).AddTicks(8558),
                            Code = "Social",
                            IsDeleted = false,
                            ModifiedTime = new DateTime(2019, 5, 4, 20, 58, 37, 329, DateTimeKind.Local).AddTicks(8558),
                            Name = "Social"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("OMG_Annalect_DAL_Core.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            AddedTime = new DateTime(2019, 5, 4, 20, 58, 37, 327, DateTimeKind.Local).AddTicks(8558),
                            Code = "UAE",
                            IsDeleted = false,
                            ModifiedTime = new DateTime(2019, 5, 4, 20, 58, 37, 328, DateTimeKind.Local).AddTicks(8558),
                            Name = "United Arab Emirates"
                        },
                        new
                        {
                            Id = 2L,
                            AddedTime = new DateTime(2019, 5, 4, 20, 58, 37, 328, DateTimeKind.Local).AddTicks(8558),
                            Code = "PK",
                            IsDeleted = false,
                            ModifiedTime = new DateTime(2019, 5, 4, 20, 58, 37, 328, DateTimeKind.Local).AddTicks(8558),
                            Name = "Pakistan"

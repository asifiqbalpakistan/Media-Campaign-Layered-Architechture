...
namespace OMG_Annalect_DAL_Core.Migrations
{
    ...
    [Migration("20190520114540_update field")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6b788cb1-c15e-4aca-a6a3-a8591f86bd90",
                            ConcurrencyStamp = "a0836b54-d015-4659-a628-2c3e284665a5",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "de11ba4e-c273-4753-8087-b42b1184618d",
                            ConcurrencyStamp = "1b34a94b-4f4a-4cde-b63a-7d22c638bd87",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "6d33b502-5d6d-4ccb-b171-c7769ca7c619",
                            ConcurrencyStamp = "1c7d4d55-833d-4ed0-b495-1a5a18ea9654",
                            Name = "Client",
                            NormalizedName = "CLIENT"
                        },
                        new
                        {
                            Id = "77d5fb7e-d211-4f9d-91bd-50daa0372b1c",
                            ConcurrencyStamp = "59f7b697-a3ea-4012-951b-f53c45466b42",
                            Name = "Planner",
            ...
            modelBuilder.Entity("OMG_Annalect_DAL_Core.Models.Channel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            AddedTime = new DateTime(2019, 5, 20, 15, 45, 39, 902, DateTimeKind.Local).AddTicks(7730),
                            Code = "Social",
                            IsDeleted = false,
                            ModifiedTime = new DateTime(2019, 5, 20, 15, 45, 39, 902, DateTimeKind.Local).AddTicks(7730),
                            Name = "Social"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("OMG_Annalect_DAL_Core.Models.Country", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            AddedTime = new DateTime(2019, 5, 20, 15, 45, 39, 900, DateTimeKind.Local).AddTicks(7730),
                            Code = "UAE",
                            IsDeleted = false,
                            ModifiedTime = new DateTime(2019, 5, 20, 15, 45, 39, 901, DateTimeKind.Local).AddTicks(7730),
                            Name = "United Arab Emirates"
                        },
                        new
                        {
                            Id = 2L,
                            AddedTime = new DateTime(2019, 5, 20, 15, 45, 39, 901, DateTimeKind.Local).AddTicks(7730),
                            Code = "PK",
                            IsDeleted = false,
                            ModifiedTime = new DateTime(2019, 5, 20, 15, 45, 39, 901, DateTimeKind.Local).AddTicks(7730),
                            Name = "Pakistan"
